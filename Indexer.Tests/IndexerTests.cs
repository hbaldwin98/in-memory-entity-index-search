...
using static Indexer.Tests.SearchTests;
...
namespace Indexer.Tests
{
    public class IndexerTests
    {
        ...
        public void Index_WithMultipleEntities_ShouldIndexCorrectly()
        {
            // Arrange
            var indexer = new Indexer<TestBase>();
            var entities = new List<TestBase>
        {
            new TestBase { Id = "1", Property1 = "foo" },
            new TestBase { Id = "2", Property1 = "bar" },
            new TestBase { Id = "3", Property1 = "baz" }
        };
        ...
        public void GetMatches_WithExistingValue_ShouldReturnMatchingObjects()
        {
            // Arrange
            var indexer = new Indexer<TestBase>();
            var entity1 = new TestBase { Id = "1", Property1 = "foo", Property2 = 42 };
            var entity2 = new TestBase { Id = "2", Property1 = "bar", Property2 = 42 };
            indexer.Index(new List<TestBase> { entity1, entity2 });
        ...
        public void GetMatches_WithInvalidPath_ShouldReturnEmptyEnumerable()
        {
            // Arrange
            var indexer = new Indexer<TestBase>();
            var entity1 = new TestBase { Id = "1", Property1 = "foo" };
            indexer.Index(entity1);
